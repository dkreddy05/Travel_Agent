...
class ConversationRepository(BaseRepository[Conversation]):
    ...
    def get_user_conversations(self, user_id: str, params: PaginationParams) -> PaginatedResult:
        query = (
            Conversation.query
    ...
    def get_user_conversation(self, user_id: str, conversation_id: str) -> Optional[Conversation]:
